...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if(document.getElementById("car-img")) {
...
function loadAndShowCar() {
    var jsonFile = 'assets/json/vehicles.json?t=' + Date.now();
...
function checkButtonStates() {
    ...
    modifyButton.disabled = count <= 0;
    previousButton.disabled = currentIndex === 0;
    nextButton.disabled = (currentIndex === count - 1 || count <= 0);
}
